...
public class MyRequestActivity extends BaseActivity {
    ...
    private void initFragemnt() {
        ...
        //初始化传入的homefragment
        mCurrentFragment = FragmentManagerWrapper.getInstance().createFragment(MyRequestFragment.class,true);
        //fragmentmanager 事务的回滚
        mFragmentManager.beginTransaction().add(R.id.my_request_content,mCurrentFragment).commit();
    }



    public static void launchMyRequestActivity(Context context) {
